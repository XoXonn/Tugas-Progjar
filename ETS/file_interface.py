...
class FileInterface:
    def __init__(self):
        # Menentukan path absolut ke direktori 'files'
        # Ini jauh lebih aman daripada os.chdir()
    ...
    def list(self, params=[]):
        try:
            # Menggunakan path absolut untuk mencari file
            list_files = glob(os.path.join(self.storage_dir, '*.*'))
            # Hanya kembalikan nama filenya, bukan path lengkap
